...
window.MS_MENU = {
  ...
  food: [
    { section: "Chaat Counter", subtitle: "Meant for sharing. Good luck.", items: [
      { name: "Fritos Chaat", star: true, desc: "Fritos, cholay, sweet yogurt, tamarind, chaat masala, herbs", price: "12", tags: ["gf"], photo: "chaat-floral.jpg" },
      { name: "Sweet Potato Chaat", desc: "Roasted sweet potatoes, mango, tamarind, yogurt, chickpeas, sev, chaat crunch", price: "14", tags: [] },
      { name: "Samosa Chaat", desc: "Crispy vegetable samosa over spiced cholay, tamarind, yogurt, herbs", price: "14", tags: ["vgn"], photo: "chaat-flowers.jpg" },
      { name: "Bhel Puri", star: true, desc: "Crispy rice puffs, chickpea strings, crisps, tamarind, amchur, mint, cilantro", price: "12", tags: ["df"] },
    ]},
    { section: "Street Bites", subtitle: "Moment makers. All of them.", items: [
      ...
      { name: "Masala Salad", desc: "Cabbage, coconut, peanuts, herbs, crispy fried onions", price: "14", tags: ["vegan", "gf available"] },
    ]},
    { section: "Heritage Mains", subtitle: "Deeply spiced, rooted in tradition.", items: [
      { name: "Super Highway Karahi", desc: "Tomato, ginger, garlic, red chili masala in a hot karahi, served with naan", price: "32", tags: ["gf available"], choose: ["Beef", "Chicken", "Paneer"], photo: "karahi-feature-graded.jpg" },
      { name: "Karachi Style Biryani", star: true, desc: "Aromatic basmati rice, rich masala, served with raita & kachoomar", price: "36", tags: ["gf available"], choose: ["Beef", "Chicken", "Paneer", "Cholay"], photo: "karahi-sunflower.jpg" },
    ...
    { section: "Curries & Comfort", subtitle: "Rich, aromatic, deeply satisfying.", items: [
      { name: "Butter Chicken / Paneer", star: true, desc: "Roast Chicken or Paneer in Ma'am Saab's golden butter curry, basmati rice", price: "32", tags: ["gf"], photo: "lamb-shank.jpg" },
      { name: "Palak Chicken / Paneer", desc: "Roast Chicken or Paneer in rich spinach and garlic curry, basmati rice", price: "32", tags: ["gf"] },
      { name: "Vegetarian Thali", star: true, desc: "Saag paneer, methi aloo, basmati rice, paratha, kachoomar", price: "29", tags: ["vegetarian", "gf available"] },
    ]},
    { section: "Breads", items: [
      { name: "Butter Naan", star: true, desc: "Soft, blistered, made for scooping", price: "5", tags: [] },
      { name: "Paratha", desc: "Flaky, buttery, griddled · two pieces", price: "9", tags: [] },
    ]},
    { section: "Rice", items: [
      { name: "Zeera Rice", desc: "Basmati rice with toasted cumin", price: "9", tags: [] },
      { name: "Biryani Rice", star: true, desc: "Basmati rice with biryani masala", price: "9", tags: [] },
    ]},
    { section: "Signature Sides", items: [
      { name: "Butter Sauce", star: true, desc: "For your naan, rice, and shameless dipping", price: "9", tags: [] },
      { name: "Methi Aloo", star: true, desc: "Creamy potatoes, fenugreek, warm spice", price: "12", tags: [] },
      { name: "Palak", desc: "Spinach slow-cooked with roasted garlic and cumin", price: "12", tags: [] },
      { name: "Lahori Cholay", desc: "Slow-simmered Lahori spiced chickpeas", price: "12", tags: [] },
    ]},
    { section: "Dips & Chutneys", note: "Each 6 · Three 15 · Sampler 24", items: [
      { name: "Mint Raita", desc: "Cool yogurt, mint, mild spice" },
      { name: "Onion Kachoomar", desc: "Onion, tomato, cucumber, chili" },
      { name: "Mint & Cilantro", desc: "Bright, herby, fresh" },
      { name: "Tamarind & Date", desc: "Sweet, tangy, deep" },
      { name: "Chili Garlic", desc: "Hot, sharp, addictive" },
      { name: "Coconut Mango", desc: "Creamy, tropical, gently spiced" },
    ]},
    { section: "Sweets", items: [
      { name: "Gulab Jamun", star: true, desc: "Rosewater dumplings, cardamom syrup, pistachio", price: "11", tags: [] },
      { name: "Seasonal Cheesecake", desc: "Chef's featured preparation", price: "12", tags: [] },
      { name: "Rasmalai Tres Leches", star: true, desc: "Rose, cardamom infused sponge, candied pistachio", price: "12", tags: [] },
      { name: "Saffron Ice Cream Sundae", desc: "Parle-G, pistachio, rose, kulfi sauce", price: "12", tags: [] },
    ]},
  ],
