...
window.MS_MENU = {
  ...
  food: [
    { section: "Chaat Counter", subtitle: "Meant for sharing. Good luck.", items: [
      ...
      { name: "Samosa Chaat", desc: "Crispy vegetable samosa over spiced cholay, tamarind, herbs", price: "14", tags: ["vegan", "df"], photo: "chaat-flowers.jpg" },
      { name: "Bhel Puri", star: true, desc: "Crispy rice puffs, chickpea strings, crisps, tamarind, amchur, mint, cilantro", price: "12", tags: ["vegan", "df"] },
    ]},
    { section: "Street Bites", subtitle: "Moment makers. All of them.", items: [
      ...
      { name: "Masala Salad", desc: "Cabbage, coconut, peanuts, herbs, fried onions, crisps", price: "14", tags: ["vegan", "gf"] },
    ]},
    { section: "Heritage Mains", subtitle: "Deeply spiced, rooted in tradition.", items: [
      { name: "Highway Karahi", desc: "Tomato, ginger, garlic, red chili masala in a hot karahi, served with naan", price: "32", tags: ["vegetarian available", "gf available"], choose: ["Beef", "Chicken", "Paneer"], photo: "karahi-feature-graded.jpg" },
      { name: "Karachi Biryani", star: true, desc: "Aromatic basmati rice, rich masala, served with raita & kachoomar", price: "36", tags: ["vegetarian available", "vegan available", "gf available"], choose: ["Beef", "Chicken", "Paneer", "Cholay"], photo: "karahi-sunflower.jpg" },
    ...
    { section: "From the Grill", subtitle: "Bold spices, high heat, big flavor.", items: [
      ...
      { name: "Boti Tikka", desc: "Kashmiri chili marinated steak cubes, garlic and pepper cream sauce", price: "34", tags: ["gf"], photo: "kabab-platter.jpg" },
      { name: "Paneer Tikka", desc: "Roasted paneer, Kashmiri chili marinade", price: "32", tags: ["gf"] },
      { name: "Frontier Kabab", star: true, desc: "Mom's recipe. Garlic and cumin spiced ground beef kabab", price: "34", tags: ["gf", "df"] },
    ]},
    { section: "Curries & Comfort", subtitle: "Rich, aromatic, deeply satisfying.", items: [
      ...
      { name: "Butter Paneer", star: true, desc: "Roast paneer in Ma'am Saab's golden butter curry, basmati rice", price: "32", tags: ["vegetarian", "gf"], printOmit: true },
      ...
      { name: "Palak Paneer", desc: "Roast paneer in rich spinach and garlic curry, basmati rice", price: "32", tags: ["vegetarian", "gf"], printOmit: true },
      { name: "Vegetarian Thali", star: true, desc: "Saag paneer, methi aloo, basmati rice, paratha, kachoomar", price: "29", tags: ["vegetarian", "vegan available", "gf available"] },
    ]},
    { section: "Breads", items: [
      ...
      { name: "Paratha", desc: "Flaky, buttery, griddled · two pieces", price: "9", tags: ["vegan"] },
    ]},
    { section: "Rice", items: [
      { name: "Zeera Rice", desc: "Basmati rice with toasted cumin", price: "9", tags: ["vegan", "gf"] },
      { name: "Biryani Rice", star: true, desc: "Basmati rice with biryani masala", price: "9", tags: ["vegan", "gf"] },
    ]},
    { section: "Signature Sides", items: [
      ...
      { name: "Methi Aloo", star: true, desc: "Creamy potatoes, fenugreek, warm spice", price: "12", tags: ["vegan", "gf"] },
      { name: "Palak", desc: "Spinach slow-cooked with roasted garlic and cumin", price: "12", tags: ["vegetarian", "gf"] },
      { name: "Cholay", desc: "Slow-simmered Lahori spiced chickpeas", price: "12", tags: ["vegan", "gf"] },
    ]},
    { section: "Dips & Chutneys", note: "Each 6 · Three 15 · Sampler 24", items: [
      ...
      { name: "Onion Kachoomar", desc: "Onion, tomato, cucumber, chili", tags: ["vegan", "gf"] },
      { name: "Mint & Cilantro", desc: "Bright, herby, fresh", tags: ["vegan", "gf"] },
      { name: "Tamarind & Date", desc: "Sweet, tangy, deep", tags: ["vegan", "gf"] },
      { name: "Chili Garlic", desc: "Hot, sharp, addictive", tags: ["vegan", "gf"] },
      { name: "Coconut Mango", desc: "Creamy, tropical, gently spiced", tags: ["vegan", "gf"] },
    ]},
    { section: "Sweets", subtitle: "Each 12 · Sampler 40 · The way every Pakistani feast should end.", items: [
      { name: "Gulab Jamun", star: true, desc: "Rosewater dumplings, cardamom syrup, pistachio", tags: ["vegetarian"] },
      { name: "Seasonal Cheesecake", desc: "NY style cheesecake · Chef's featured preparation", tags: ["vegetarian"] },
      { name: "Rasmalai Tres Leches", star: true, desc: "Rose, cardamom infused sponge, candied pistachio", tags: ["vegetarian"] },
      { name: "Saffron Ice Cream Sundae", desc: "Parle-G & Biscoff crumble, pistachio, rose, kulfi sauce", tags: ["vegetarian"] },
    ]},
  ],
